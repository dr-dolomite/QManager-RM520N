...
//
// The liveness chip, the cadence chip and the "Refresh now" pill are all
// deliberately CUT here — per-user direction, not a mock correction. Only
// "Copy diagnostics" remains, since it is the one action here that is not a
// duplicate of the sidebar's own passive refresh behaviour.
//
